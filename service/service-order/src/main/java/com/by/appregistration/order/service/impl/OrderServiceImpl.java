package com.by.appregistration.order.service.impl;
...
import com.by.appregistration.common.helper.HttpRequestHelper;
import com.by.appregistration.common.result.ResultCodeEnum;
import com.by.appregistration.enums.OrderStatusEnum;
import com.by.appregistration.hosp.client.HospitalFeignClient;
import com.by.appregistration.model.order.OrderInfo;
import com.by.appregistration.model.user.Patient;
import com.by.appregistration.order.mapper.OrderMapper;
import com.by.appregistration.order.service.OrderService;
import com.by.appregistration.order.service.WeixinService;
import com.by.appregistration.user.client.PatientFeignClient;
import com.by.appregistration.vo.hosp.ScheduleOrderVo;
import com.by.appregistration.vo.msm.MsmVo;
import com.by.appregistration.vo.order.*;
import com.by.common.rabbit.constant.MqConst;
import com.by.common.rabbit.service.RabbitService;
...
public class OrderServiceImpl extends
    ...
    public Boolean cancelOrder(Long orderId) {
        ...
        if(quitTime.isBeforeNow()) {
            throw new AppRegistrationException(ResultCodeEnum.CANCEL_ORDER_NO);
        }
        //调用医院接口实现预约取消
